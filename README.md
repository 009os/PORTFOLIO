<div align="center">
    <a href="https://omjishukla.com"><h1 align="center">Omji Shukla - Portfolio</h1></a>
...
Create a `.env` file similar to [`.env.example`](https://github.com/omjishukla/portfolio/blob/main/.env.example).
