			...
			<div className="w-full max-w-4xl mx-auto px-4 md:px-8 py-16 mt-20 md:mt-16">
				...
				<div className="mb-6 md:mb-8 animate-slide-up" style={{ animationDelay: '0.3s' }}>
					<a 
						...
						className="block"
					>
						<div className="bg-gradient-to-br from-zinc-900/30 via-zinc-800/20 to-zinc-900/30 backdrop-blur-sm border border-zinc-600/30 rounded-xl p-4 md:p-6 lg:p-8 hover:border-zinc-500/50 transition-all duration-500 hover:scale-[1.02] group cursor-pointer">
							{/* Header */}
							...
							{/* Call to Action */}
							<div className="inline-flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-zinc-500/20 to-zinc-600/20 text-zinc-300 rounded-lg border border-zinc-500/30 hover:bg-zinc-500/30 hover:text-zinc-200 transition-all duration-300 group-hover:scale-105 text-sm md:text-base">
