	...
	return (
		<div className="flex flex-col items-center justify-center w-screen min-h-screen bg-gradient-to-tl from-black via-zinc-600/20 to-black relative overflow-x-hidden">
			...
			<div className="absolute inset-0 overflow-hidden pointer-events-none">
				...
				<div className="absolute bottom-32 left-20 w-3 h-3 bg-blue-400 rounded-full animate-bounce opacity-50"></div>
			...
			<div className="w-full max-w-4xl mx-auto px-4 md:px-8 py-16 mt-20 md:mt-16">
				...
				<div className="text-center mb-8 md:mb-12 animate-fade-in">
					<div className="flex justify-center mb-4 md:mb-6">
						<div className="p-3 md:p-4 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full border border-purple-500/30">
							<PenTool className="w-6 h-6 md:w-8 md:h-8 text-purple-400" />
						</div>
					</div>
					...
					<div className="w-24 md:w-32 h-1 bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 mx-auto mb-4 md:mb-6 animate-slide-in"></div>
				...
				<div className="mb-6 md:mb-8 animate-slide-up" style={{ animationDelay: '0.3s' }}>
					<div className="bg-gradient-to-br from-purple-900/30 via-pink-900/20 to-indigo-900/30 backdrop-blur-sm border border-purple-500/30 rounded-xl p-4 md:p-6 lg:p-8 hover:border-purple-400/50 transition-all duration-500 hover:scale-[1.02] group">
						{/* Header */}
						<div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 md:mb-6 gap-3">
							<div className="flex items-center gap-3 md:gap-4">
								<div className="p-2 md:p-3 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg border border-purple-500/30 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
									<BookOpen className="w-5 h-5 md:w-6 md:h-6 text-purple-400" />
								</div>
								<div className="flex-1 min-w-0">
									<h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-zinc-100 mb-1 group-hover:text-purple-300 transition-colors duration-300">
										हुजरे की शाम
									</h2>
									<p className="text-purple-400 font-medium text-sm md:text-base">Huzre Ki Shaam</p>
								</div>
							</div>
							<div className="text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hidden md:block">
						...
						<div className="mb-4 md:mb-6">
							<div className="flex items-start gap-2 md:gap-3 mb-3 md:mb-4">
								<Quote className="w-4 h-4 md:w-5 md:h-5 text-purple-400 mt-1 flex-shrink-0" />
						...
						<a 
							...
							className="inline-flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-purple-500/20 to-pink-500/20 text-purple-300 rounded-lg border border-purple-500/30 hover:bg-purple-500/30 hover:text-purple-200 transition-all duration-300 group-hover:scale-105 text-sm md:text-base"
						>
				...
				<div className="text-center animate-slide-up" style={{ animationDelay: '0.4s' }}>
					<div className="bg-zinc-900/30 backdrop-blur-sm border border-zinc-700/30 rounded-xl p-4 md:p-6">
						...
						<div className="flex flex-wrap justify-center gap-1 md:gap-2">
							<span className="px-2 md:px-3 py-1 bg-pink-500/20 text-pink-400 rounded-full text-xs md:text-sm border border-pink-500/30">dilkashi</span>
							<span className="px-2 md:px-3 py-1 bg-teal-500/20 text-teal-400 rounded-full text-xs md:text-sm border border-teal-500/30">uns</span>
							<span className="px-2 md:px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-xs md:text-sm border border-blue-500/30">ishq</span>
							<span className="px-2 md:px-3 py-1 bg-purple-500/20 text-purple-400 rounded-full text-xs md:text-sm border border-purple-500/30">akidat</span>
							<span className="px-2 md:px-3 py-1 bg-indigo-500/20 text-indigo-400 rounded-full text-xs md:text-sm border border-indigo-500/30">ibadat</span>
							<span className="px-2 md:px-3 py-1 bg-red-500/20 text-red-400 rounded-full text-xs md:text-sm border border-red-500/30">junoon</span>
							<span className="px-2 md:px-3 py-1 bg-orange-500/20 text-orange-400 rounded-full text-xs md:text-sm border border-orange-500/30">maut</span>
						</div>
					</div>
				</div>
			</div>
